      ...
      <PageEditorStack pageKey="home" frames={[
        ...
        {key:'holding-quotes',element:
          <FrameCard title="持股行情模塊">
            ...
            <HoldingQuoteCollection rows={sorted} style={quoteStyle} layoutMode={holdingLayoutMode} wallConfig={editor.displayConfig.holdingWall} onOpenHolding={onOpenHolding}/>
