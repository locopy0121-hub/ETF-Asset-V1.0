        ...
        {key:'holding-view',element:
          <FrameCard title="持股檢視">
            ...
            {viewMode==='list'?<HoldingTable rows={sorted} onOpenHolding={onOpenHolding}/>:<>
              ...
              <HoldingQuoteCollection rows={sorted} style={quoteStyle} layoutMode={holdingLayoutMode} wallConfig={editor.displayConfig.holdingWall} refreshToken={finance.sharedSnapshot.generatedAt} onOpenHolding={onOpenHolding}/>
