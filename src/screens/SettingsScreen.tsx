...
export function SettingsScreen(){
  ...
  function appSection(){
    return <View style={styles.children}>
      ...
      <ChildButton label="更新資訊" summary="V2.1.3 全局設定、帳務明細及股息月曆修護（驗收中）" active={appPanel==='updates'} onPress={()=>setAppPanel(toggleExclusivePanel(appPanel,'updates'))}/>
      {appPanel==='updates'?<Panel title="V2.1.3 更新資訊">
