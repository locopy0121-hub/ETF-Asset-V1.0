...
export const ENGINEER_SKILLS:readonly EngineerSkill[]=[
  ...
  {id:'animations',label:'動態動畫',description:'跑馬燈、呼吸燈、提醒動畫',tools:[later('marquee','跑馬燈','需綁定動畫與生命週期'),ready('blink','閃爍','framefx:blinkEnabled','真實框架原生邊框閃爍；獨立系統調色盤／損益色與週期；降低動態時靜態顯示；不遮蔽數據')]},
