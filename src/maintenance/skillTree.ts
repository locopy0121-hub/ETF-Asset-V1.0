...
export const ENGINEER_SKILLS:readonly EngineerSkill[]=[
  ...
  {id:'frames',label:'專業框架工程',description:'背景／邊框／陰影／光圈／內外距／動畫與適配；僅對目前框架生效',tools:[
    ...
    ready('fx-bg-mode','① 純色／漸層模式','framefx:backgroundMode','保留既有純色；開啟雙色漸層原地預覽'),
    ...
    later('fx-background-image','① 背景圖片與遮罩','需要先接入安全檔案選取與裁切'),
    later('fx-multi-gradient','① 多色／角度漸層','須接入原生高性能漸層引擎'),
