...
const options:Partial<Record<keyof FrameEffects,readonly (readonly [string,string])[]>>={
  backgroundMode:[['solid','純色'],['gradient','雙色漸層']],
...
const colorProfitFlag:Partial<Record<keyof FrameEffects,
  'gradientEndProfitColor'|'shadowProfitColor'|'glowProfitColor'>>={
  gradientEndColor:'gradientEndProfitColor',shadowColor:'shadowProfitColor',glowColor:'glowProfitColor',
};
