...
export function InspectableTarget({target,frame,children,flex=false}:{
  ...
  if(!engineer.enabled)return appearance.visible?<>{children(appearance,customized,override)}</>:null;
...
const styles=StyleSheet.create({
  wrench:{position:'absolute',right:-5,top:-13,zIndex:8,elevation:8,
    minWidth:32,minHeight:32,borderRadius:17,borderWidth:1,justifyContent:'center',alignItems:'center'},
});
