...
assert.match(settings,/const VERSION='1\.0\.5'/,'Settings version display must be 1.0.5');
assert.match(settings,/const BUILD='10005'/,'Settings build display must be 10004');

console.log('TF_ASSET_SETTINGS_V105_CONTRACT: PASS');
