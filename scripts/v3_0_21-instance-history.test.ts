...
assert.equal(all.length,184);assert.equal(audit.readyDeclared,151);assert.equal(audit.pending,33);
...
console.log('V3.0.25 owned installed A history: snapshots/strict keys/cap/restore/backup/AB PASS');
