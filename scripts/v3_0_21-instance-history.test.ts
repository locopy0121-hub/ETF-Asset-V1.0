...
assert.equal(all.length,184);assert.equal(audit.readyDeclared,153);assert.equal(audit.pending,31);
...
console.log('V3.0.27 owned installed A history: snapshots/strict keys/cap/restore/backup/AB PASS');
