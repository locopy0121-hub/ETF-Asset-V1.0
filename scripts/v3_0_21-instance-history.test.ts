...
assert.equal(all.length,184);assert.equal(audit.readyDeclared,152);assert.equal(audit.pending,32);
...
console.log('V3.0.26 owned installed A history: snapshots/strict keys/cap/restore/backup/AB PASS');
