...
assert.equal(all.length,184);assert.equal(audit.readyDeclared,150);assert.equal(audit.pending,34);
...
console.log('V3.0.24 owned installed A history: snapshots/strict keys/cap/restore/backup/AB PASS');
