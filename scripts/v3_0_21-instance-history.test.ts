...
assert.equal(all.length,184);assert.equal(audit.readyDeclared,147);assert.equal(audit.pending,37);
...
console.log('V3.0.21 owned installed A history: snapshots/strict keys/cap/restore/backup/AB PASS');
console.log('184 central skills, 147 declared wired / 37 pending; no finance or built-in mutations PASS');
