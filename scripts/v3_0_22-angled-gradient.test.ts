...
console.log('V3.0.23 arbitrary-angle frame native gradient: legacy/degree/layout/tool/AB/identity PASS');
console.log('184 skills / 149 declared wired / 35 pending; actual device testing separate');
