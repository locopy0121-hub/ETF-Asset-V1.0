...
console.log('V3.0.22 arbitrary-angle frame native gradient: legacy/degree/layout/tool/AB/identity PASS');
console.log('184 skills / 148 declared wired / 36 pending; actual device testing separate');
