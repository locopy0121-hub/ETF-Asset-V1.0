...
assert.ok(runtime.includes('cancel:()=>setSession(null)'),'cancel must never persist drafts');
...
assert.equal(a.expo.version,'3.0.1');
assert.equal(a.expo.android.versionCode,30001);
