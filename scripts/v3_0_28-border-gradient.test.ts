...
assert.equal(AB_PROPERTY_TOOL_IDS.length,184);assert.equal(audit.readyDeclared,155);assert.equal(audit.pending,29);
...
console.log('V3.0.29 native dual/gradient frame-border regression PASS: 155 wired / 29 pending; device separate');
