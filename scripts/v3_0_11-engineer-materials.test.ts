...
assert.ok(read('src/screens/SettingsScreen.tsx').includes("const VERSION='3.0.20'"));
assert.ok(read('src/screens/SettingsScreen.tsx').includes("const BUILD='30020'"));
assert.ok(read('src/settings/BackupService.ts').includes("const APP_VERSION='3.0.20'"));
