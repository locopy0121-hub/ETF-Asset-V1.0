...
assert.match(settings,/const VERSION='1\.0\.4'/,'Settings version display must be 1.0.4');
assert.match(settings,/const BUILD='10004'/,'Settings build display must be 10004');

console.log('TF_ASSET_SETTINGS_V104_CONTRACT: PASS');
