...
assert.ok(wf.includes('TF-Asset-V3.0.27-QA.apk')&&wf.includes("github.head_ref == 'go-v3.0.27-20260927-shadow-spread'"));
...
console.log('V3.0.27 native A simulation: seven sandbox states, readonly source, no persistence, AB and finance PASS');
