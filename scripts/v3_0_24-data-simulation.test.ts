...
assert.ok(wf.includes('TF-Asset-V3.0.29-QA.apk')&&wf.includes("github.head_ref == 'go-v3.0.29-20260927-native-entrance'"));
...
console.log('V3.0.29 native A simulation: seven sandbox states, readonly source, no persistence, AB and finance PASS');
