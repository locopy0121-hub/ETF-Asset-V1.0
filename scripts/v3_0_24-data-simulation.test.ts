...
assert.ok(wf.includes('TF-Asset-V3.0.28-QA.apk')&&wf.includes("github.head_ref == 'go-v3.0.28-20260927-border-gradient'"));
...
console.log('V3.0.28 native A simulation: seven sandbox states, readonly source, no persistence, AB and finance PASS');
