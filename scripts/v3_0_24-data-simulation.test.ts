...
assert.ok(wf.includes('TF-Asset-V3.0.26-QA.apk')&&wf.includes("github.head_ref == 'go-v3.0.26-20260927-frame-marquee'"));
...
console.log('V3.0.26 native A simulation: seven sandbox states, readonly source, no persistence, AB and finance PASS');
